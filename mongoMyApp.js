...
var findPeopleByName = function(personName, done) {
  Person.find({name: personName}, function (err, docFound) {
    if (err) return console.log(err);
    //If success
...
var findOneByFood = function(food, done) {
  //finOne looks for any 'food' item in property array favouriteFoods !
...
var findEditThenSave = function(personId, done) {
  ...
  Person.findById( personId, function (err, docFound) {
    ...
    //If success
    console.log(docFound);
    //Add new item to favourite food array of found document
    docFound.favoriteFoods.push( foodToAdd);
    docFound.save(function(err, data) {
        if (err) return done(err);
        //Do Something if you succeed
        done(null, data);
      });
...
var removeById = function(personId, done) {
  ...
  Person.findByIdAndRemove( personId, function (err, docFound) {
    if (err) return console.log(err);
    //If success
    console.log(docFound); 
    done(null, docFound);
